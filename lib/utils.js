...
exports.getIdentifier = exports.mergeWithDefaultChangelogRules = exports.mapCustomReleaseRules = exports.getLatestPrereleaseTag = exports.getLatestTag = exports.isPrereleaseBranch = exports.isReleaseBranch = exports.isPullRequest = exports.getBranchFromRef = exports.getCommits = exports.getValidTags = void 0;
...
function isReleaseBranch(releaseBranches, currentBranch) {
    return releaseBranches
        .split(',')
        .some((branch) => currentBranch.match(branch));
}
exports.isReleaseBranch = isReleaseBranch;
function isPrereleaseBranch(preReleaseBranches, currentBranch) {
...
exports.isPrereleaseBranch = isPrereleaseBranch;
...
function getIdentifier(appendToPreReleaseTag, appendCommitRef, commitRef) {
