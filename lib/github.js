...
exports.createTag = exports.compareCommits = exports.listTags = exports.getPullRequestHeadSha = exports.getOctokitSingleton = void 0;
...
function getPullRequestHeadSha() {
    ...
    if (github_1.context.eventName.startsWith('pull_request')) {
        var pullRequestPayload = github_1.context.payload;
        commitSha = pullRequestPayload.pull_request.head.sha;
    }
    return commitSha;
}
exports.getPullRequestHeadSha = getPullRequestHeadSha;
/**
