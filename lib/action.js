...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const isPr = (0, utils_1.isPullRequest)(GITHUB_EVENT_NAME);
        var commitRef = '';
        if (isPr) {
            commitRef = (0, github_1.getPullRequestHeadSha)();
        }
        else {
            commitRef = GITHUB_SHA;
        }
        const currentBranch = (0, utils_1.getBranchFromRef)(GITHUB_REF);
        const isPrerelease = !(0, utils_1.isReleaseBranch)(currentBranch, releaseBranches) || isPr;
